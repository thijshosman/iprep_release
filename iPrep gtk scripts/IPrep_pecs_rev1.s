...
// rev1: as in Manchester. av control gate valve is different. no coating

class pecs_iprep_rev1: object
{
	...
	void stageHome(object self)
	{
		...
		sleep(2) // to make sure we return when stage is actually at home
	...
	void pecs_iprep_rev1(object self)
	{
		//constructor
	...
	void openGVandCheck(object self)
	{
		...
		// specific to pinout (av2/av3) of Manchester system
