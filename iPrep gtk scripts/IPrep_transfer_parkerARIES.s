...
// assumes parker ARIES controller (as installed in Manchester)
// hardware/software used: ACR-View 6.4.0.1053
// project Aries_IPrep, device ARxxCE


class parkerTransfer_ARIES:object
{
	...
	void parkerTransfer_ARIES(object self)
	{
		// *** public ***
		// constructor
	...
	void init(object self)
	{
		...
		self.sendCommand("TLM AXIS0 10") // basic test, verified reseat works

		//self.turnOff()
		
		self.print("parker ARIES initialized")
